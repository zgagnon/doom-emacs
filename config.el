...
(when (and (eq system-type 'darwin) (getenv "NIX_PATH"))
...
(use-package! claude-code-ide
  ...
  (defun claude-code-ide--with-nix-develop (orig-fun &rest args)
    ...
    (let* ((current-dir default-directory)
           (wrapper-script (expand-file-name "~/.doom.d/claude-code-nix-wrapper.sh"))
  ...
  (defun claude-code-ide--get-wrapped-shell ()
    ...
    (let ((wrapper-script (expand-file-name "~/.doom.d/claude-code-nix-wrapper.sh")))
